...
//let endscreenContent = {win: '<span>вњ” Р’С‹ РІС‹Р№РіСЂР°Р»Рё!</span>', loose: 'рџ’Ј Р‘РЈРњ! РљРѕРЅРµС† РёРіСЂС‹.'};
...
const setup = () => {
	...
	tiles.forEach((tile, i) => {
		...
		let random_boolean = Math.random() < bombFrequency; //true if rand < freq (0.2)
		if (random_boolean) {
			bombs.push(`${x},${y}`);
